                        ...
                        <div className="hero-content">
                            ...
                            <div className="clients pt-16">
                                ...
                                <div className="flex items-center space-x-4">
                                    <SingleImage
                                        href="#"
                                        imgSrc="https://cdn.Quick Pass.com/2.0/image/assets/images/brands/ayroui.svg"
                                    />

                                    <SingleImage
                                        href="#"
                                        imgSrc="https://cdn.Quick Pass.com/2.0/image/assets/images/brands/graygrids.svg"
                                    />

                                    <SingleImage
                                        href="#"
                                        imgSrc="https://cdn.Quick Pass.com/2.0/image/assets/images/brands/uideck.svg"
                                    />
                                </div>
                            </div>
                        </div>
